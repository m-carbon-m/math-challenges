...
class Pinguin(Tier):
    ...
    def general_infos(self):
        print(f"Der Pinguin ist {'ein Säugetier' if self.is_mammal else 'kein Säugetier'}, ist {'kaltblütig' if self.is_cold_blooded else 'warmblütig'} und hat {self.num_appendages} Extremitäten.")  
    ...
    def sleep(self):
        print(f"{self.name} schläft in einer Mulde im Schnee.")
    ...
    def dive(self):
        print(f"{self.name} taucht ins Wasser.")